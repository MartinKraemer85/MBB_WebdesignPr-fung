...
from website.views import about_us, bocchi, contact_us, dataprotection, image_galery, impressum, recipes, sports
...
urlpatterns = [
    ...
    path(
        "",
        login_not_required(TemplateView.as_view(template_name="website/index.html")),
        name="website",
    ),
