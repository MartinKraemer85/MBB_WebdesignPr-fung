/******/ (() => { // webpackBootstrap
/*!*********************************************************!*\
  !*** ./foodplaner/static/foodplaner/src/ts/calendar.ts ***!
  \*********************************************************/
...
const domEventHandler = {
    ...
    handleCalendarClick: (el, day, month, year) => {
        const newUrl = `/foodplaner/calendar/${year}/${month}/${day}/`;
        history.pushState({}, "", newUrl); // change url to current clicked calendar Element
        // open Modal
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.body.addEventListener("htmx:afterSwap", function (evt) {
        // optional check for the calendar
